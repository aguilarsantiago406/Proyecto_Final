...
# Modelo para credenciales por cliente (GHL + MP)
class ClientIntegration(models.Model):
    name = models.CharField(max_length=150, blank=True, default="")

    # GHL OAuth
    ghl_access_token = models.CharField(max_length=255, blank=True, default="")
    ghl_refresh_token = models.CharField(max_length=255, blank=True, default="")
    ghl_location_id = models.CharField(max_length=100, blank=True, default="")

    # Mercado Pago OAuth
    mp_access_token = models.CharField(max_length=255, blank=True, default="")
    mp_refresh_token = models.CharField(max_length=255, blank=True, default="")
    ...
    def __str__(self):
        label = self.name or self.ghl_location_id or self.mp_user_id or str(self.id)
        return f"ClientIntegration {label}"